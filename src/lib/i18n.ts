...
const dict = {
  ...
  "weather.title": { en: "Weather", zh: "天气" },
  // Named as the city, not the campus: Open-Meteo answers for a coordinate,
  // and that coordinate is Kunming - there is no sensor on campus.
  "weather.source": { en: "Kunming · Open-Meteo", zh: "昆明 · Open-Meteo" },
  "weather.feels": { en: "Feels like", zh: "体感" },
  "weather.wind": { en: "Wind", zh: "风速" },
  "weather.rain": { en: "Chance of rain", zh: "降水概率" },
  "weather.loading": { en: "Checking the sky…", zh: "正在获取天气…" },
  "weather.unavailable": {
    en: "Weather unavailable right now.",
    zh: "暂时无法获取天气。",
  },
  "weather.retry": { en: "Try again", zh: "重试" },

  "rate.title": { en: "Rate your ride", zh: "为本次乘车评分" },
  "rate.subtitle": { en: "Average per line", zh: "各线路平均分" },
  "rate.prompt": { en: "How was it?", zh: "本次乘车如何？" },
  "rate.comment": { en: "Anything to add? (optional)", zh: "想补充什么？（选填）" },
  "rate.submit": { en: "Send rating", zh: "提交评分" },
  "rate.sending": { en: "Sending…", zh: "提交中…" },
  "rate.thanks": { en: "Thanks — your rating was saved.", zh: "谢谢，评分已保存。" },
  "rate.already": {
    en: "You already rated this line recently.",
    zh: "你最近已经为该线路评过分了。",
  },
  "rate.none": { en: "No ratings yet", zh: "暂无评分" },
  // English needs the singular; Chinese uses the same measure word either way.
  "rate.count.one": { en: "rating", zh: "条评分" },
  "rate.count": { en: "ratings", zh: "条评分" },
  "rate.failed": { en: "Could not save the rating.", zh: "评分保存失败。" },

  "lost.title": { en: "Lost & Found", zh: "失物招领" },
  "lost.subtitle": { en: "Items left on campus buses", zh: "校园公交遗失物品" },
  "lost.report": { en: "Report an item", zh: "登记物品" },
  "lost.cancel": { en: "Cancel", zh: "取消" },
  "lost.kind.lost": { en: "I lost something", zh: "我丢了东西" },
  "lost.kind.found": { en: "I found something", zh: "我捡到了东西" },
  "lost.what": { en: "What is it?", zh: "是什么物品？" },
  "lost.details": { en: "Details (optional)", zh: "详细描述（选填）" },
  "lost.line": { en: "Bus line", zh: "线路" },
  "lost.stop": { en: "Near which stop?", zh: "靠近哪一站？" },
  "lost.contact": { en: "How can you be reached? (optional)", zh: "联系方式（选填）" },
  "lost.contact.warning": {
    en: "Anyone using this app can see what you type here.",
    zh: "此处填写的内容对所有使用者可见。",
  },
  "lost.send": { en: "Post it", zh: "发布" },
  "lost.sending": { en: "Posting…", zh: "发布中…" },
  "lost.posted": { en: "Posted. Good luck!", zh: "已发布，祝你好运！" },
  "lost.failed": { en: "Could not post that.", zh: "发布失败。" },
  "lost.empty": {
    en: "Nothing reported yet.",
    zh: "暂无登记物品。",
  },
  "lost.resolved": { en: "Returned", zh: "已归还" },
  "lost.markreturned": { en: "Mark returned", zh: "标记为已归还" },
  "lost.anyline": { en: "Any line", zh: "不限线路" },
  "lost.anystop": { en: "Any stop", zh: "不限站点" },
  "lost.needtitle": { en: "Please say what the item is.", zh: "请填写物品名称。" },

  "alert.title": { en: "Alert me before my bus", zh: "到站前提醒我" },
  "alert.stop": { en: "Which stop?", zh: "哪一站？" },
  "alert.lead": { en: "Tell me", zh: "提前" },
  "alert.leadunit": { en: "min before", zh: "分钟提醒" },
  "alert.on": { en: "Turn on alerts", zh: "开启提醒" },
  "alert.off": { en: "Turn off alerts", zh: "关闭提醒" },
  "alert.watching": { en: "Watching", zh: "正在监听" },
  // The honest caveat. This fires from the open page, not from a server, so
  // it cannot reach anyone once the tab is closed - and a student who missed
  // their bus trusting otherwise would be right to be annoyed.
  "alert.caveat": {
    en: "Works while this app is open, including in a background tab. It cannot reach you once the tab is closed.",
    zh: "仅在本应用打开时有效（可在后台标签页）。关闭标签页后将无法提醒。",
  },
  "alert.denied": {
    en: "Your browser has blocked notifications for this site. You can re-enable them in the site settings.",
    zh: "浏览器已阻止本站通知，可在站点设置中重新开启。",
  },
  "alert.unsupported": {
    en: "This browser cannot show notifications.",
    zh: "此浏览器不支持通知。",
  },
  "alert.nobus": { en: "No bus serves that stop.", zh: "该站点暂无公交线路。" },

  // ---- Panel headings and table columns ----
  // These were hard-coded English inside the components, so switching the app
  // to Chinese left every dashboard heading and every table column in English.
  "capacity.title": { en: "Capacity Alerts", zh: "运力提醒" },
  "capacity.subtitle": { en: "Waiting passengers vs free seats", zh: "候车人数与空座对比" },
  "queue.title": { en: "Passenger Queues", zh: "候车队列" },
  "queue.subtitle": { en: "Waiting passengers per stop", zh: "各站候车人数" },
  "queue.none": { en: "No one waiting", zh: "无人候车" },
  "peak.title": { en: "Peak-Hour Schedule Timeline", zh: "高峰时段班次时间轴" },
  "peak.subtitle": { en: "Morning 08-10, Afternoon 16-18", zh: "早高峰 08-10，晚高峰 16-18" },
  "peak.aria": { en: "Schedule timeline", zh: "班次时间轴" },
  "report.title": { en: "System Report Summary", zh: "系统报告摘要" },
  "report.subtitle": { en: "Same fields as reports/report.txt", zh: "字段与 reports/report.txt 一致" },
  "board.title": { en: "Campus Bus Route Board", zh: "校园公交线路牌" },
  "board.subtitle": { en: "Yunnan University reference", zh: "云南大学参考资料" },
  "timeline.title": { en: "Route Timeline", zh: "线路时间轴" },
  "dijkstra.title": { en: "Interactive Shortest Route", zh: "最短路径演示" },
  "dijkstra.subtitle": {
    en: "Calculated by a Dijkstra function in TypeScript",
    zh: "由 TypeScript 实现的 Dijkstra 算法计算",
  },
  "dijkstra.busline": { en: "Bus line", zh: "公交线路" },
  "backup.title": { en: "Backup & restore", zh: "备份与恢复" },
  "error.generic": { en: "Something went wrong", zh: "出错了" },
  "error.body": {
    en: "The app hit an unexpected error. Reloading usually fixes it.",
    zh: "应用遇到意外错误，刷新页面通常可以解决。",
  },
  "error.reload": { en: "Reload", zh: "刷新" },

  "table.stops": { en: "Stops", zh: "站点" },
  "table.buses": { en: "Buses", zh: "车辆" },
  "table.routes": { en: "Routes", zh: "线路" },
  "table.schedules": { en: "Schedules", zh: "班次" },
  "table.waiting": { en: "Waiting", zh: "候车" },
  "table.plate": { en: "Plate", zh: "车牌" },
  "table.onboard": { en: "Onboard", zh: "车上人数" },
  "table.usage": { en: "Usage", zh: "使用率" },
  "table.connection": { en: "Connection", zh: "路段" },
  "table.weight": { en: "Weight", zh: "权重" },
  "table.departure": { en: "Departure", zh: "发车" },
  "table.arrival": { en: "Arrival", zh: "到达" },
  "table.name": { en: "Name", zh: "名称" },
  "table.capacity": { en: "Cap.", zh: "座位" },
  "table.line": { en: "Line", zh: "线路" },
  "table.time": { en: "Time", zh: "时间" },
  "table.bus": { en: "Bus", zh: "车辆" },
  "table.peak": { en: "Peak", zh: "高峰" },
  ...
  "driver.paxoff": { en: "One passenger off", zh: "下车一人" },
  "driver.paxon": { en: "One passenger on", zh: "上车一人" },
  "driver.email": { en: "Driver email", zh: "司机邮箱" },
  "driver.password": { en: "Password", zh: "密码" },
  "driver.passwordph": { en: "Driver password", zh: "司机密码" },

  "editor.heading": { en: "Live Campus Editor", zh: "校园数据实时编辑器" },
  "editor.email": { en: "Email", zh: "邮箱" },
  "editor.password": { en: "Password", zh: "密码" },
  "editor.name.en": { en: "Name (English)", zh: "名称（英文）" },
  "editor.name.zh": { en: "Name (Chinese)", zh: "名称（中文）" },
  "editor.mapx": { en: "Map X (0-100)", zh: "地图 X（0-100）" },
  "editor.mapy": { en: "Map Y (0-100)", zh: "地图 Y（0-100）" },
  "editor.routename": { en: "Route name", zh: "线路名称" },
  "editor.traveltime": { en: "Travel time (minutes)", zh: "行驶时间（分钟）" },
  "editor.paxadd": { en: "Add a waiting passenger", zh: "增加一位候车乘客" },
  "editor.paxremove": { en: "Remove a waiting passenger", zh: "减少一位候车乘客" },
  "editor.cloud.live": { en: "Cloud connected · live", zh: "已连接云端 · 实时" },
  "editor.cloud.polling": {
    en: "Cloud connected · refreshing every 20s",
    zh: "已连接云端 · 每 20 秒刷新",
  },
